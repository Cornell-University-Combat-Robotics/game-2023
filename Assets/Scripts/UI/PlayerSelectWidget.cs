...
public class PlayerSelectWidget : MonoBehaviour
{
  ...
  private GameManager.Robot[] OrderedRobots = {GameManager.Robot.Rosie, GameManager.Robot.Florence, GameManager.Robot.Hanako, GameManager.Robot.Steve, GameManager.Robot.Manny};
